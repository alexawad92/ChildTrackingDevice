...
from TagUnassigned import TagUnassigned
class Registration:
...
##        self.frame.pack()
        ...
        self.frame.pack()
        self.UnassignedButton = ttk.Button(self.frame, text = 'Unassigned A Tag', style="C.TButton" ,width = 25, command = self.TagUnassigned)
        self.UnassignedButton.pack()
        self.frame.pack()
...
##        self.frame.pack()
    ...
    def TagUnassigned(self):
        self.newWindow = tk.Toplevel(self.master)
        TagUnassignedObj = TagUnassigned(self.newWindow)
