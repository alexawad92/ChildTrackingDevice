...
class CamperReg:
    def __init__(self, master):
        ...
        CamperName = tk.Label(self.frame, text="CamperName")
    ...
    def Register(self):
        ...
        DBObj.InsertToCamper(CamperName, Active_start, Active_end, Active_Flag)
        content = tk.StringVar()
        WELCOME_MSG = CamperName + ''' Camper has been registered.
        Thank You!'''
        WELCOME_DURATION = 3000
        top = tk.Toplevel()
        top.title('Camper Registration')
